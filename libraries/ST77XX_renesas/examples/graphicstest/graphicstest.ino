...
//ST7789_renesas tft = ST7789_renesas(TFT_CS, TFT_DC, TFT_MOSI, TFT_SCK, TFT_RST);
...
//ST7789_renesas tft = ST7789_renesas(&SPI, TFT_CS, TFT_DC, TFT_RST);

// For 3.5" or 4.0" TFT with ST7796
ST7796_renesas tft = ST7796_renesas(&SPI1, TFT_CS, TFT_DC, TFT_RST);
