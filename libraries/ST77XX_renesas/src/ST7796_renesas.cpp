...
ST7796_renesas::ST7796_renesas(SPIClass *pspi, uint8_t CS, uint8_t DC, uint8_t RST) :
    ST77XX_renesas(pspi, CS, DC, RST) 
{
}
...
void  ST7796_renesas::begin(uint16_t width, uint16_t height, uint8_t mode, uint32_t spi_clock)
{
...
void  ST7796_renesas::setRotation(uint8_t m) 
{
  beginSPITransaction();
