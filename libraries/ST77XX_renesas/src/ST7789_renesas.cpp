...
ST7789_renesas::ST7789_renesas(SPIClass *pspi, uint8_t CS, uint8_t DC, uint8_t RST) :
...
void  ST7789_renesas::begin(uint16_t width, uint16_t height, uint8_t mode, uint32_t spi_clock)
{
...
void  ST7789_renesas::setRotation(uint8_t m) 
{
  beginSPITransaction();
